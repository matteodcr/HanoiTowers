...
def nombre_disques(plateau:list, index_tour) -> int: 
    '''Renvoie le nombre de disques dans index_tour'''
    return len(plateau[index_tour])


def disque_superieur(plateau: list, index_tour) -> int: 
...
def verifier_deplacement(plateau:list, index_tour_dep, index_tour_fin) -> bool:
...
def verifier_victoire(plateau:list, n) -> bool: 
